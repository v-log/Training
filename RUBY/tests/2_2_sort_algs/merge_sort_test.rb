...
class MergeSortTest < Minitest::Test
  ...
  # Testing #merge_sort!
  def test_merge_sort_without_block
      assert_equal @sorted_ary, merge_sort!(@unsorted_ary), "Array hasn't been sorted"
  end

  def test_merge_sort_without_block_with_rand_ary
    rand_ary_1 = (0...100).to_a.shuffle
    rand_ary_2 = rand_ary_1.dup
    assert_equal rand_ary_1.sort, merge_sort!(rand_ary_2), "Array hasn't been sorted properly"
  end

  def test_merge_sort_with_block
    merge_sort!(@unsorted_hash) { |item| -item[1] }
    assert_equal @sorted_hash, @unsorted_hash, "Array hasn't been sorted"
  end

  def test_merge_sort_with_block_with_rand_ary
    ...
    merge_sort!(pairs_copy) { |item| -item[1] }
